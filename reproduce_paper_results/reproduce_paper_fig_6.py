...
plt.savefig(str(fig_path) + "/figure_6.png")
plt.savefig(str(fig_path) + "/figure_6.eps")
plt.savefig(str(fig_path) + "/figure_6.pdf")
...
plt.savefig(str(fig_path) + "/figure_6_legend.png")
plt.savefig(str(fig_path) + "/figure_6_legend.eps")
plt.savefig(str(fig_path) + "/figure_6_legend.pdf")
